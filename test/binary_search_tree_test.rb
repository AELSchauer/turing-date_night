...
class BinarySearchTreeTest < Minitest::Test
  ...
  def test_bst_include_has_correct_output_after_second_insert
    # skip #include
    tree = BinarySearchTree.new
    tree.insert(61,"Bill and Ted's Excellent Adventure")
  ...
  def test_bst_max_has_correct_output_after_second_insert
    # skip #max
    tree = BinarySearchTree.new
    tree.insert(61,"Bill and Ted's Excellent Adventure")
    tree.insert(16, "Johnny English")
  ...
  def test_bst_min_has_correct_output_after_second_insert
    # skip #min
    tree = BinarySearchTree.new
    tree.insert(61,"Bill and Ted's Excellent Adventure")
    tree.insert(16, "Johnny English")
  ...
  def test_bst_load_has_correct_output_comparing_unique_and_not_unique
    # skip #load
  ...
  def test_bst_health_has_correct_output_with_few_inserts
    # skip #health
    tree = BinarySearchTree.new
  ...
  def test_bst_health_has_correct_output_with_many_inserts
    # skip #health
    tree = BinarySearchTree.new
